...
},{"./_a-function":"node_modules/core-js/modules/_a-function.js"}],"node_modules/core-js/modules/_cof.js":[function(require,module,exports) {
...
},{"./_iterators":"node_modules/core-js/modules/_iterators.js","./_wks":"node_modules/core-js/modules/_wks.js"}],"node_modules/core-js/modules/_to-integer.js":[function(require,module,exports) {
// 7.1.4 ToInteger
var ceil = Math.ceil;
...
},{"./_to-integer":"node_modules/core-js/modules/_to-integer.js"}],"node_modules/core-js/modules/core.get-iterator-method.js":[function(require,module,exports) {
...
},{"./_redefine":"node_modules/core-js/modules/_redefine.js"}],"node_modules/core-js/modules/_set-to-string-tag.js":[function(require,module,exports) {
...
},{"./_object-dp":"node_modules/core-js/modules/_object-dp.js","./_has":"node_modules/core-js/modules/_has.js","./_wks":"node_modules/core-js/modules/_wks.js"}],"node_modules/core-js/modules/_set-species.js":[function(require,module,exports) {
...
},{"./_global":"node_modules/core-js/modules/_global.js","./_object-dp":"node_modules/core-js/modules/_object-dp.js","./_descriptors":"node_modules/core-js/modules/_descriptors.js","./_wks":"node_modules/core-js/modules/_wks.js"}],"node_modules/core-js/modules/_iter-detect.js":[function(require,module,exports) {
var ITERATOR = require('./_wks')('iterator');
...
},{"./_wks":"node_modules/core-js/modules/_wks.js"}],"node_modules/core-js/modules/es6.promise.js":[function(require,module,exports) {
...
var Canvas = /*#__PURE__*/function () {
  function Canvas(width, height, parent) {
    ...
    this.__canvas.style.width = "".concat(width, "px");
    this.__canvas.style.height = "".concat(height, "px");
...
},{}],"src/classes/states/State.js":[function(require,module,exports) {
"use strict";
...
function normalizeAngle(theta) {
  return (theta + Math.PI * 2) % (Math.PI * 2); // angle = angle % (2 * Math.PI)
...
var Camera = /*#__PURE__*/function () {
  ...
  _createClass(Camera, [{
    ...
    key: "screenResolutionWidth",
    get: function get() {
      this.__screenResolutionWidth;
    }
  }, {
    key: "screenResolutionHeight",
    get: function get() {
...
exports.default = FPS;
},{"../entities":"src/classes/entities/index.js"}],"src/classes/graphics/Texture.js":[function(require,module,exports) {
"use strict";
...
var Texture = /*#__PURE__*/function () {
  ...
  _createClass(Texture, [{
    ...
    key: "drawImageRotatedSlice",
    value: function drawImageRotatedSlice(ctx, x, y, xOffset, yOffset, radians, distance, sliceHeight) {
    ...
    key: "drawPixel",
    value: function drawPixel(ctx, px, py, x, y, w) {
...
},{"../Map":"src/classes/Map.js"}],"src/classes/graphics/Sprite.js":[function(require,module,exports) {
"use strict";
...
var Enemy = /*#__PURE__*/function (_Entity) {
  ...
  function Enemy(handler, x, y, width, height, sprite) {
...
exports.Enemy = Enemy;
},{"../index":"src/classes/entities/index.js"}],"src/classes/Map.js":[function(require,module,exports) {
"use strict";
...
var _Texture = _interopRequireDefault(require("./graphics/Texture"));

var _Sprite = _interopRequireDefault(require("./graphics/Sprite"));

var _Player = require("./entities/Player");

var _Enemy = require("./entities/Enemies/Enemy");
...
var Map = /*#__PURE__*/function () {
  function Map(handler) {
    ...
    var level = this.__handler.getLevel();

    var structures = level.getStructures();
    var textureMap = level.getTextureMap();
    this.__textures = textureMap.textures;
    var player = level.getEntities().player;
    this.__player = new _Player.Player(this.__handler, player.position.x * Map.TILE_SIZE, player.position.y * Map.TILE_SIZE, Map.TILE_SIZE, Map.TILE_SIZE, new _Sprite.default(this.__textures.entities.player));
    var enemies = level.getEntities().enemies.map(function (enemy) {
      return new _Enemy.Enemy(_this.__handler, enemy.position.x * Map.TILE_SIZE, enemy.position.y * Map.TILE_SIZE, Map.TILE_SIZE, Map.TILE_SIZE, new _Sprite.default(_this.__textures.entities[enemy.type]));
    });
    this.__entities = {
      enemies: enemies
    };
...
exports.default = Map;
},{"./graphics/Texture":"src/classes/graphics/Texture.js","./graphics/Sprite":"src/classes/graphics/Sprite.js","./entities/Player":"src/classes/entities/Player.js","./entities/Enemies/Enemy":"src/classes/entities/Enemies/Enemy.js"}],"src/classes/renderers/raycast/Ray.js":[function(require,module,exports) {
"use strict";
...
var TwoD = /*#__PURE__*/function () {
  function TwoD(handler, ctx, map, scale) {
    ...
    this.__camerasize = _Map.default.TILE_SIZE;
    this.__ctx = ctx;
...
},{"../../utils/Math":"src/classes/utils/Math.js","../raycast/Ray":"src/classes/renderers/raycast/Ray.js","../../Map":"src/classes/Map.js"}],"src/classes/renderers/raycast/index.js":[function(require,module,exports) {
"use strict";
...
var RayCast = /*#__PURE__*/function () {
  function RayCast(handler, ctx, map, scale) {
    ...
    this.__rays = [];
    this.__scale = scale;
    this.__siteDistance = 20 * _Map.default.TILE_SIZE;
    this.__map = map;
...
},{"../../utils/Math":"src/classes/utils/Math.js","../raycast/Ray":"src/classes/renderers/raycast/Ray.js","../../Map":"src/classes/Map.js"}],"src/classes/states/GameState.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(GameState, [{
    ...
    value: function setup() {
      ...
      this.__map.getEntities().enemies.forEach(function (enemy) {
        _this.__minimapRenderer.addEntity(enemy);

        _this.__raycastRenderer.addEntity(enemy);
      });
...
var ImageLoader = /*#__PURE__*/function () {
  ...
  _createClass(ImageLoader, null, [{
    key: "loadImage",
    value: function () {
      var _loadImage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(path) {
    ...
    key: "LoadImages",
    value: function () {
      var _LoadImages = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(images) {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return Promise.all(images.map(function (image) {
                  return ImageLoader.loadImage(image);
                }));
...
},{}],"src/classes/Level.js":[function(require,module,exports) {
"use strict";
...
var _Texture = _interopRequireDefault(require("./graphics/Texture.js"));
...
var levelsJson = "./levels/levels.json";
...
var Level = /*#__PURE__*/function () {
  function Level(level) {
    ...
    this.__path = "levels/".concat(level.path);
    this.createEmmitters();
  }

  _createClass(Level, [{
    key: "createEmmitters",
    value: function createEmmitters() {
      this.__emmitters = {
        status_change: [],
        load_complete: []
      };
    ...
    key: "getTextureMap",
    value: function getTextureMap() {
      return this.__textureMap;
    }
  }, {
    key: "loadComplete",
    value: function loadComplete() {
      this.__emmitters.load_complete.forEach(function (callback) {
        callback();
      });
    }
  }, {
    ...
    value: function updateStatus(status) {
      ...
      this.__emmitters.status_change.forEach(function (callback) {
        callback(status);
      });
    }
  }], [{
...
},{"./Map.js":"src/classes/Map.js","./graphics/Texture.js":"src/classes/graphics/Texture.js","./graphics/ImageLoader.js":"src/classes/graphics/ImageLoader.js","./utils/AssetLoader.js":"src/classes/utils/AssetLoader.js"}],"src/classes/controller/Menu.js":[function(require,module,exports) {
"use strict";
...
var Menu = /*#__PURE__*/function () {
  function Menu(canvas) {
    ...
    this.__eventListeners = {
      mousemove: function mousemove(e) {
        return _this.setMousePostion(e);
      },
    ...
    Object.keys(this.__eventListeners).forEach(function (event) {
      _this.__canvas.addEventListener(event, _this.__eventListeners[event]);
    });
  }
  ...
  _createClass(Menu, [{
    ...
    value: function deconstruct() {
      ...
      Object.keys(this.__eventListeners).forEach(function (event) {
        _this2.__canvas.removeEventListener(event, _this2.__eventListeners[event]);
      });
    }
  }, {
    key: "mouseClick",
    value: function mouseClick(e) {
      ...
      this.__emitListeners.click.forEach(function (callback) {
        callback.apply(void 0, _toConsumableArray(_this3.__mousePosition));
      });
    }
  }, {
    key: "keydown",
    value: function keydown(e) {
      this.__emitListeners.keydown.forEach(function (callback) {
        callback(e);
      });
    }
  }, {
    ...
    value: function keyup(e) {
      this.__emitListeners.keyup.forEach(function (callback) {
        callback(e);
      });
    }
  }, {
    key: "setMousePostion",
    value: function setMousePostion(_ref) {
      var _this4 = this;

      var clientX = _ref.clientX,
          clientY = _ref.clientY;

      var _this$__canvas$getBou = this.__canvas.getBoundingClientRect(),
          left = _this$__canvas$getBou.left,
          top = _this$__canvas$getBou.top;

      this.__mousePosition = [clientX - left, clientY - top];

      this.__emitListeners.mousemove.forEach(function (callback) {
        callback.apply(void 0, _toConsumableArray(_this4.__mousePosition));
      });
    }
  }, {
...
},{}],"src/classes/graphics/GUI/GUI.js":[function(require,module,exports) {
"use strict";
...
var Component = /*#__PURE__*/function () {
  function Component(controller, x, y, width, height, callback) {
  ...
  _createClass(Component, [{
    ...
    value: function setupEvents() {
      ...
      this._controller.on("click", function (e) {
        if (_this._states.hover) {
          _this._callback();
        }
      });

      this._controller.on("mousemove", function (x, y) {
        if (x > _this._x && x < _this._x + _this._width && y > _this._y && y < _this._y + _this._height) {
          if (!_this._states.hover) {
            _this._states.hover = true;

            _this.mouseEnter(x, y);
          }
        } else {
          if (_this._states.hover) {
            _this._states.hover = false;

            _this.mouseLeave(x, y);
          }
        }
      });
    }
...
},{}],"src/classes/graphics/GUI/Button.js":[function(require,module,exports) {
"use strict";
...
var Button = /*#__PURE__*/function (_Component) {
  ...
  function Button(controller, style, text, callback) {
    var _this;

    _classCallCheck(this, Button);

    style.hover = _objectSpread(_objectSpread({}, defaultStyle.hover), style.hover);
    style.text = _objectSpread(_objectSpread({}, defaultStyle.text), style.text);
    style.border = _objectSpread(_objectSpread({}, defaultStyle.border), style.border);
    ...
    _this = _super.call(this, controller, x - style.padding, y - style.padding, width + style.padding * 2, height + style.padding * 2, callback);
    _this._style = style;
    _this._hoverStyle = _objectSpread(_objectSpread(_objectSpread({}, defaultStyle), style), style.hover);
    _this._drawStyle = _this._style;
    _this._text = text;
    return _this;
  }
  ...
  _createClass(Button, [{
    key: "mouseEnter",
    value: function mouseEnter(mouseX, mouseY) {
    ...
    key: "draw",
    value: function draw(ctx) {
      var _this$_drawStyle = this._drawStyle,
          background = _this$_drawStyle.background,
          padding = _this$_drawStyle.padding,
          border = _this$_drawStyle.border,
          text = _this$_drawStyle.text;
      ...
      ctx.fillText(this._text, this._x + this._width / 2 + padding, this._y + this._height / 2 + padding);
    }
  }]);
...
},{"./GUI":"src/classes/graphics/GUI/GUI.js"}],"src/classes/states/LevelSelectState.js":[function(require,module,exports) {
"use strict";
...
var _Button = _interopRequireDefault(require("../graphics/GUI/Button"));
...
var LevelSelectState = /*#__PURE__*/function () {
  function LevelSelectState(handler) {
      ...
      var _setup = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.__controller = new _Menu.default(this.__canvas.getCanvas());
                this.__buttons = [];
                _context.next = 4;
                return _Level.default.getLevels();

              case 4:
                this.__levels = _context.sent;
                this.__buttons = this.__levels.map(function (level, index) {
                  var width = 150;
                  var height = 30;
                  return new _Button.default(_this.__controller, {
                    ...
                    lvl.on("load_complete", function () {
                      _this.__controller.deconstruct();
...
var Game = /*#__PURE__*/function () {
  ...
  _createClass(Game, [{
    ...
    key: "setState",
    value: function setState(state) {
      _State.default.setState(this["__".concat(state, "State")]);
    }
  }, {
    key: "draw",
    value: function draw() {
    ...
    key: "state",
    get: function get() {
      return _State.default.getState();
    }
  }]);
